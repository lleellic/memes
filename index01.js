...
bot.start((ctx) => ctx.reply('Привет'+'${ctx.from.username}',ctx.from.id+'! Я бот для мышеловки! Рад познакомиться! Введи команду /help для ознакомления со списком моих команд!'))
