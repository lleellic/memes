...
(msg.data == 'COOMMAND1') ? ( bot.answerCallbackQuery(msg.id, 'Вы вошли в игру', false), bot.sendMessage(msg.chat.id,'Набор игроков для игры: Было не было', startb), console.log('6')):
