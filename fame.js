...
c[1] = '3️⃣ Кито';
d[1] = '4️⃣ Бразилиа';
answ[2] = 'Какого цвета изначально была морковь';
a[2] = '1⃣ Желтая';
b[2] = '2️⃣ Фиолетовая';
c[2] = '3️⃣ Розовая';
d[2] = '4️⃣ Зеленая';
...
c[6] = '3️⃣ Красителя';
d[6] = '4️⃣ Макияжа';
answ[7] = '8. За бороду раньше в Англии ... /n 3️⃣ Присуждали премию';
...
c[9] = '3️⃣ Камень';
d[9] = '4️⃣ Дерево';
answ[10] = '11. Кто был последним императором западной Римской Империи?';
a[10] = '1⃣ Луций';
b[10] = '2️⃣ Антоний Пи';
