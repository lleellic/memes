...
bot.sendMessage(msg.from.id, '<a href="tg://user?id='+admin[0]+'">osculum</a> - создатель бота\nВы можете написать ему',{parse_mode:"HTML"})
})
